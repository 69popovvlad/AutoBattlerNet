...
{
    /// Reusable wrapper around ChunkGrid + gizmos
    [ExecuteAlways]
    public class ChunkGridBehaviour : MonoBehaviour
    {
        [Header("Grid")]
        ...
        public ChunkGrid ChunkGrid => _chunkGrid;

        private void Awake() => RebuildGrid();
        private void OnValidate() => RebuildGrid();
